...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("border-0", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn("[&_tr]:border-b border-neutral-550 ", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-neutral-550 bg-slate-100/50 font-medium dark:bg-slate-800/50",
      className,
    )}
    {...props}
  />
