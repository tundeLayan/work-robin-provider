...
const onRequest = (
  ...
  request.headers.Authorization = `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoicHJvdmlkZXJfN1NYTlZZRjJGOEpkUEZXQiIsImlhdCI6MTcxOTUyODIyMCwiZXhwIjoxNzE5NjE0NjIwfQ.gerdcW8tja8Pxm16hSuPSbGlXMWSJ9kCUjgP8SySCd0`;
